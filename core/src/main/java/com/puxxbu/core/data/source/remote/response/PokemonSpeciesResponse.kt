package com.puxxbu.core.data.source.remote.response
...
data class PokemonSpeciesResponse(
    ...
    val generation: PokemonSpeciesGeneration? = null,
...
data class FlavorTextEntriesItem(
    ...
    val version: PokemonSpeciesVersion? = null,
...
data class PokemonSpeciesGeneration(
