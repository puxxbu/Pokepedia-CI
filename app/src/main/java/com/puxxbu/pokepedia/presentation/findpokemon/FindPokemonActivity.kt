package com.puxxbu.pokepedia.presentation.findpokemon
...
import com.puxxbu.core.utils.Format
import com.puxxbu.pokepedia.R
import com.puxxbu.pokepedia.databinding.ActivityFindPokemonBinding
import com.puxxbu.pokepedia.presentation.detail.DetailActivity
    ...
    private fun handleOnSuccess(resource: Resource<Pokemon>) {
        binding.apply {
            ...
            Glide.with(this@FindPokemonActivity).load(resource.data?.imageUrl)
                .placeholder(com.puxxbu.core.R.drawable.ic_pokeball_primary)
